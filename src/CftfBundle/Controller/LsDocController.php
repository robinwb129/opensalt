...
class LsDocController extends Controller
{
    ...
    public function updateAction(Request $request, LsDoc $lsDoc)
    {
        ...
        $frameworkUpdater->update($lsDoc, base64_decode($fileContent), $frameworkToAssociate);
    ...
    public function updateDerivativeAction(Request $request, LsDoc $lsDoc)
    {
        ...
        $frameworkUpdater->derivative($lsDoc, base64_decode($fileContent), $frameworkToAssociate);
